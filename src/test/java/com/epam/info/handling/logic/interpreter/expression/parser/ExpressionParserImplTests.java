...
import com.epam.info.handling.logic.interpreter.expression.parser.impl.ExpressionParserImpl;
import org.junit.Assert;
import org.junit.Test;

import java.util.List;

public class ExpressionParserImplTests {
    ...
    public void testParseShouldReturnListWithOneNonTerminalExpressionWhenGivenOnlyOneNumber() {
        ExpressionParser<Integer> parser = new ExpressionParserImpl();

        List<AbstractExpression> expressions = parser.parse(ONE_NUMBER);
    ...
    public void testParseShouldReturnListWithTwoNonTerminalAndOneTerminalAddExpressionsWhenGivenAddingOfTwoNumbers() {
        ...
        List<AbstractExpression> expressions = parser.parse(TWO_NUMBERS_ADDING);

        checkFirstNonTerminalExpression(expressions);
        checkSecondNonTerminalExpression(expressions);

        AbstractExpression thirdExpression = expressions.get(THIRD);
    ...
    public void testParseShouldReturnListWithTwoNonTerminalAndOneTerminalSubtractExpressionsWhenGivenSubtractingOfTwoNumbers() {
        ...
        List<AbstractExpression> expressions = parser.parse(TWO_NUMBERS_SUBTRACTING);
    ...
    public void testParseShouldReturnListWithTwoNonTerminalAndOneTerminalMultiplyExpressionsWhenGivenMultiplyingOfTwoNumbers() {
        ...
        List<AbstractExpression> expressions = parser.parse(TWO_NUMBERS_MULTIPLYING);
    ...
    public void testParseShouldReturnListWithTwoNonTerminalAndOneTerminalDivideExpressionsWhenGivenDividingOfTwoNumbers() {
        ...
        List<AbstractExpression> expressions = parser.parse(TWO_NUMBERS_DIVIDING);
    ...
    public void testParseShouldReturnListWithTwoNonTerminalAndOneTerminalPowExpressionsWhenGivenExponentiationOfTwoNumbers() {
        ...
        List<AbstractExpression> expressions = parser.parse(TWO_NUMBERS_EXPONENTIATION);
    ...
    private void checkFirstNonTerminalExpression(List<AbstractExpression> expressions) {
        AbstractExpression firstExpression = expressions.get(FIRST);
    ...
    private void checkSecondNonTerminalExpression(List<AbstractExpression> expressions) {
        AbstractExpression secondExpression = expressions.get(SECOND);
